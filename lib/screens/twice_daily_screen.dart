...
class _TwiceDailyScreenState extends State<TwiceDailyScreen> {
  ...
  Future<void> _pickTime(int intake) async {
    final initial = intake == 1 ? firstTime : secondTime;
    final picked = await showTimePicker(context: context, initialTime: initial);
    if (picked != null) {
      setState(() { intake == 1 ? firstTime = picked : secondTime = picked; });
    }
  }
  ...
  Future<void> _saveAndNavigate() async {
    ...
    try {
      ...
      final entry = MedicineEntry(
        ...
        condition: widget.condition, frequency: 'twice',
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text("Set your morning and evening schedule",
                  textAlign: TextAlign.center,
